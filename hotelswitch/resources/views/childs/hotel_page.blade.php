...
<div id=hotel_page class="right">
    ...
    <div class="hp_head">
        <div class="hp_head_tittle">
            <div class="hp_tittle">
                <span class="hp_name">{{$name ?? 'Hotel Royal Sample'}}</span>
                <div class="hp_stars_wrapper">
                    <span class="hp_stars">★★★★★</span>
                </div>
            </div>
            <div class="hp_address">
                <i class="fas fa-map-marker-alt hp_map_icon" aria-hidden="true"></i>
                <span class="hp_address_content">Av. D. João II, n.º 27, Parque das Nações, Lisboa,
                    1990-083, Portugal</span>
                <span>-</span>
                <span class="hp_see_map">See Map</span>
            </div>
            <div class="hp_distance_center">
                <span class="hp_distance_center_content">355 m from city center
                </span>
            </div>
        ...
        <div class="hp_head_book">
            <div class="hp_nightly_price">
                <span class="hp_header_price">€99</span>
            </div>
            <div class="hp_head_nightly_text">
                <span>nightly price per room</span>
            </div>
            <div class="hp_total_price">
                <strong class="hp_total_price_text">198€</strong>
                <span class="hp_header_nights">for 2 nights</span>
            </div>
    ...
    <div class="hp_gallery">
        ...
        <div class="hp_slides_index">
            <div class="hp_min_slide">
                <img class="hp_slide_img" src="" alt="">
            </div>
        </div>
        <div class="hp_hotel_review">
            <div class="quality_number">
                <div class="quality_wrapper">
                    <span class="quality">Very Good</span>
                </div>
                <div class="nr_reviews_wrapper">
                    <span class="nr_reviews">1423</span>
                    <span>reviews</span>
                </div>
            </div>
        ...
        <div class="hp_search">
            <div class="hp_dates_wrapper hp_search_box">
                <div class="hp_dates_box">
                    <div class="hp_box_wrapper">
                        ...
                        <div class="hp_box_text"><span class="hp_box_check_in">2020-07-22</span></div>
                    </div>
                </div>
                <div class="hp_dates_box hp_box_divider">
                    <div class="hp_box_wrapper">
                        <div class="hp_box_title"><span>Checkout</span></div>
                        <div class="hp_box_text"><span class="hp_box_check_out">2020-07-25</span></div>
                    </div>
                </div>
            </div>
            <div class="hp_guests_wrapper hp_search_box">
                <div class="hp_box_wrapper">
                    ...
                    <div class="hp_box_text"><span class="hp_box_guests">1 room, 2 adults</span></div>
                </div>
            </div>
