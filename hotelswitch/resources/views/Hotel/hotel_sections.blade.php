    ...
    <div id=hotel_page class="right_content">
        ...
        <div class="gallery">
            ...
            <div class="slides_index">
                @isset($h)
                    @for ($i=0; $i < count($h->images_min); $i++)
                        <div class="min_slide"><img class="slide_img" src={{$h->images_min[$i]}} alt=""
                                                    main={{$h->images[$i]}}
                                                        index={{$i}}>
                        </div>@endfor
                @endisset
        ...
        <div class="availability" id="availability">
            ...
            <div class="search_update">
                <div class="dates_wrapper search_box">
                    <div class="dates_box">
                        <div class="box_wrapper">
                            <div class="box_title"><span>Check-in</span></div>
                            <div class="box_text"><span class="box_check_in">{{$h->check_in ?? '2020-07-22'}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="dates_box box_divider">
                        <div class="box_wrapper">
                            <div class="box_title"><span>Checkout</span></div>
                            <div class="box_text"><span class="box_check_out">{{$h->check_out ?? '2020-07-25'}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="guests_box search_box">
                    <div class="box_wrapper">
                        <div class="box_title"><span>Guests</span></div>
                        <div class="box_text"><span
                                class="box_guests">{{isset($h->adults) ? $h->rooms_text . ", " . $h->adults_text  : '1 room, 2 adults'}}</span>
                        </div>
                    </div>
                </div>
