...
use App\Offer;
// use App\Http\classes\hotel_page_class;
...
class HotelController extends Controller
{
    public function index()
    {
        ...
        $static = Static_content::find($hotel_id);
        $info   = Offer::where('info', 'exists', true)->first();
        $offer  = Offer::find($hotel_id);

        $h = new Hotel($static,$offer,$info);
